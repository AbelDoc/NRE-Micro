...
<html>
    <head>
        ...
        <title>NRE-Micro: /mnt/c/Users/abell/Documents/GitHub/NRE-Micro/src/LED/Effect/NRE_RotateFixEffect.hpp File Reference</title>
...
<div class="title">NRE_RotateFixEffect.hpp File Reference</div>  </div>
</div><!--header-->
<div class="contents">

<p>Declaration of <a class="el" href="namespace_micro.php" title="Micro&#39;s API. ">Micro</a>'s API's Object : RotateFixEffect.  
...
<p><a href="_n_r_e___rotate_fix_effect_8hpp_source.php">Go to the source code of this file.</a></p>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="nested-classes"></a>
Classes</h2></td></tr>
<tr class="memitem:"><td class="memItemLeft" align="right" valign="top">class &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="class_n_r_e_1_1_micro_1_1_rotate_fix_effect.php">NRE::Micro::RotateFixEffect</a></td></tr>
<tr class="memdesc:"><td class="mdescLeft">&#160;</td><td class="mdescRight">Represent a rotate light effect, setting leds on one by one, leds remains on while the effect is running.  <a href="class_n_r_e_1_1_micro_1_1_rotate_fix_effect.php#details">More...</a><br /></td></tr>
...
<div class="textblock"><p>Declaration of <a class="el" href="namespace_micro.php" title="Micro&#39;s API. ">Micro</a>'s API's Object : RotateFixEffect. </p>
