...
<tr id="row_3_1_" class="even"><td class="entry"><span style="width:32px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="class_n_r_e_1_1_micro_1_1_wave_effect.php" target="_self">NRE::Micro::WaveEffect</a></td><td class="desc">Represent a wave light effect, setting all leds to the same color, starting from black to the given color and then back to black </td></tr>
